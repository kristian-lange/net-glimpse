...
//        });
        return buildWebSocket(webSocketDispatcherActorRef);
    }

    public static <T> LegacyWebSocket<JsonNode> buildWebSocket(ActorRef dispatcher) {
        return new LegacyWebSocket<JsonNode>() {
            ...
            public Props actorProps(ActorRef out) {
                try {
                    return Props.create(WebSocketActor.class, out, dispatcher);
