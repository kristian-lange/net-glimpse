@REM play-java-seed launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PLAY_JAVA_SEED_config.txt found in the PLAY_JAVA_SEED_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%PLAY_JAVA_SEED_HOME%"=="" set "PLAY_JAVA_SEED_HOME=%~dp0\\.."

set "APP_LIB_DIR=%PLAY_JAVA_SEED_HOME%\lib\"
...
set "CFG_FILE=%PLAY_JAVA_SEED_HOME%\PLAY_JAVA_SEED_config.txt"
set CFG_OPTS=
if exist "%CFG_FILE%" (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running play-java-seed.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !PLAY_JAVA_SEED_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
